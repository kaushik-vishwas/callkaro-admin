...
export function ReviewReceiverPage() {
  ...
  const canReview = kyc?.reviewStatus === 'pending';
    ...
    <DashboardShell>
      <div className={styles.page}>
        <div className={styles.topBar}>
          <div>
            <Link to="/verification" className={styles.back}>
              ...
              <button
                ...
                onClick={() =>
                  void runAction(async () => {
                    ...
                    navigate(`/verification/${profile.id}/approved`);
                  })
                }
              >
                <CircleCheck size={15} />
        ...
        {loading ? <p className={styles.muted}>Loading KYC…</p> : null}
          ...
          <div className={styles.layout}>
            <div className={styles.left}>
              ...
              <section className={styles.card}>
                ...
                {kyc.photos.length === 0 ? (
                  <p className={styles.muted}>No photos uploaded.</p>
                ) : (
              ...
              <section className={styles.card}>
                ...
                <dl className={styles.kv}>
                  ...
                  <div>
                    ...
                    <dd>
                      {profile.agentName || '—'}
                      {profile.agentCode ? ` (${profile.agentCode})` : ''}
                    </dd>
                  </div>
                  <div>
                    <dt>Submitted</dt>
